...
class TanhTransformedDistribution(tfd.TransformedDistribution):
    """Tanh-squashed distribution with mode calculation."""
...
class Normal(nn.Module):
    """Gaussian head on top of a base module.

    Attributes:
        base_cls: Base module class producing the features this head reads.
        action_dim: Action dimension.
        log_std_min: Minimum value of log standard deviation.
        log_std_max: Maximum value of log standard deviation.
        learnable_log_std_multiplier: Optional learnable multiplier on log standard deviation.
        learnable_log_std_offset: Optional learnable offset on log standard deviation.
        state_dependent_std: Whether to use state-dependent standard deviation.
        squash_tanh: Whether to squash the action with tanh.
        fixed_log_std: Optional constant that overrides the predicted log standard deviation.
    """
